                        ...
                        <div className="flex items-center justify-between h-16">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="hidden lg:block text-xs text-gray-500">Learn together, grow together</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center px-4 py-2 bg-kidemia-primary text-white rounded-lg hover:bg-kidemia-primary/90 transition-colors font-medium shadow-sm"
                                >
